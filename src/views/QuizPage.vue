    ...
    <div class="container mx-auto px-4 max-w-6xl">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
          ...
          <div class="mb-6">
            ...
            <div class="w-full bg-gray-200 rounded-full h-2.5">
              <div class="bg-blue-500 h-2.5 rounded-full transition-all duration-300"
                :style="{ width: `${((currentIndex + 1) / quiz.length) * 100}%` }"></div>
            </div>
          </div>
          ...
          <div v-if="currentQuestion" class="space-y-6">
            ...
            <div class="space-y-2">
              ...
              <p class="inline-block px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-sm font-medium">
            ...
            <div class="space-y-3">
              <label v-for="option in currentQuestion.options" :key="option.key"
                ...
                <input v-if="currentQuestion.isMultipleChoice" type="checkbox" :value="option.key"
                  :checked="currentAnswers.includes(option.key)" @change="toggleAnswer(option.key)"
                  class="w-5 h-5 text-blue-500 border-gray-300 rounded focus:ring-blue-500" />
                <input v-else type="radio" :value="option.key" v-model="currentAnswers"
            ...
            <div class="flex justify-between pt-4">
              ...
              <button v-if="currentIndex < quiz.length - 1" @click="nextQuestion"
      ...
      <template v-else>
        <div class="space-y-6">
          ...
          <!-- 題目檢討 -->
          <div class="space-y-6">
            <div v-for="question in quizResult.questions" :key="question.id" class="bg-white rounded-lg shadow-sm p-6">
              <div class="space-y-4">
                <div class="space-y-2">
                  <h2 class="text-xl text-gray-800 font-medium">
                ...
                <div class="space-y-3">
                  <div v-for="option in question.options" :key="option.key" class="p-4 rounded-lg" :class="{
