          ...
          >
            ...
            >
              ...
              <div class="flex justify-between items-start mb-3">
                ...
                <span
                  class="shrink-0 ml-2 px-2.5 py-1 text-xs font-medium rounded-full"
                  :class="{
        ...
        <div class="p-6 max-h-[calc(100vh-200px)] overflow-y-auto">
          <div class="prose max-w-none">
            <div class="mb-6">
              ...
              <div
                class="bg-gray-50 rounded-lg p-4 font-mono text-sm text-gray-700 border border-gray-200"
              >
