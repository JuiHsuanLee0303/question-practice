<template>
  ...
  >
    ...
    <div class="mt-8 mx-4 sm:mx-auto sm:w-full sm:max-w-md">
      <div
        class="bg-white py-8 px-4 shadow-xl rounded-xl sm:rounded-2xl sm:px-10 ring-1 ring-gray-900/5"
      >
        ...
        <div
          v-if="error"
          class="mt-4 p-4 bg-red-50 rounded-xl border border-red-100 flex items-center space-x-2"
        >
