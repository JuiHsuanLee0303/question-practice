    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
      ...
      <div class="mb-8">
        <div class="flex justify-between items-center mb-4">
          ...
          <button @click="toggleAllChapters"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          <label v-for="chapter in chapters" :key="chapter.id"
            ...
            <input type="checkbox" v-model="selectedChapters" :value="chapter.id"
      ...
      <div class="mb-8">
        ...
        <div class="max-w-xs">
          <div class="flex items-center space-x-4">
            <input type="number" v-model="numberOfQuestions" min="1" :max="maxQuestions"
              class="w-24 p-3 text-gray-700 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-center" />
